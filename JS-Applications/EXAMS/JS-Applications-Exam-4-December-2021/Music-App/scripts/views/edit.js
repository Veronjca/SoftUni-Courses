...
import { editAlbumHandler } from "../handlers/editAlbum.js";
    ...
    <form @submit=${editAlbumHandler}>
      <fieldset>
        ...
        <div class="container">
          ...
          <textarea name="description" class="description" rows="10" cols="10" .value=${album.description}>
...
export const editView = async (ctx) => {
  ...
  render(editTemplate(album), mainContainer);
};
